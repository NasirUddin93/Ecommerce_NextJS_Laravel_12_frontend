...
import { FilterState } from '../types/sale';
import { FilterOptions } from '../data/mockSale';
// import { Star, X, Filter, Tag, Zap, AlertTriangle, Fire } from 'lucide-react';
import { Star, X, Filter, Tag, Zap, AlertTriangle, Flame } from 'lucide-react';
...
<div className="mb-6">
  ...
  <div className="space-y-2">
    {([
      ...
      { value: 'weekly-deals', label: 'Weekly Deals', icon: Flame }
