...
export default function CategoriesPage() {
  const [orderItems, setOrderItems] = useState<Review[]>([]);
            ...
            <tbody>
              {filteredOrderItems.map((orderItem) => (
                ...
                >
                  ...
                  <td className="px-6 py-3 font-medium">{orderItem.rating}</td>
                  <td className="px-6 py-3 font-medium">{orderItem.comment}</td>
