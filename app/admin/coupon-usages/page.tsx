...
export default function CategoriesPage() {
  ...
  return (
    <AdminLayout>
      ...
      <Link
              href="/admin/coupon-usages/create"
          ...
          <table className="min-w-full text-sm text-left text-gray-600">
            <thead className="bg-gray-100 text-gray-700 uppercase text-xs">
              <tr>
                ...
                <th className="px-6 py-3">Caupon ID</th>
            ...
            <tbody>
              {filteredOrderItems.map((orderItem) => (
                ...
                >
                  ...
                  <td className="px-6 py-3 font-medium">{orderItem.coupon_id}</td>
                  <td className="px-6 py-3 font-medium">{orderItem.user_id}</td>
                  <td className="px-6 py-3 font-medium">{orderItem.order_id}</td>
                  <td className="px-6 py-3 font-medium">{orderItem.used_at}</td>
