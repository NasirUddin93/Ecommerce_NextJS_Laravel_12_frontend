    ...
    <div className="min-h-screen flex bg-gray-100">
      ...
      >
        ...
        <nav className="p-4 space-y-2">
          ...
          <a href="/brands" className="block p-2 rounded hover:bg-gray-200">
            Brands
          </a>
          <a href="/products" className="block p-2 rounded hover:bg-gray-200">
            Products
          </a>
          <a href="/orders" className="block p-2 rounded hover:bg-gray-200">
            Orders
          </a>
          <a href="/users" className="block p-2 rounded hover:bg-gray-200">
            Users
          </a>
          <a href="/reports" className="block p-2 rounded hover:bg-gray-200">
            Reports
          </a>
        </nav>
      </aside>
